...
function Assignment() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${LIVE_URL}/assignment/assignment`); // Replace with your API endpoint
  ...
  const handleNotesDelete = async (user) => {
    if (window.confirm(`Are you sure you want to delete ${user.name}?`)) {
      try {
        await axios.delete(`${LIVE_URL}/assignment/assignment/${user._id}`);
  ...
  const handleNotesSaveEdit = async () => {
    try {
      await axios.put(`${LIVE_URL}/assignment/assignment/${notesEdit._id}`, notesEdit);
      // const updatedUsers = noteData.map((user) =>
      //   user._id === editedUser._id ? editedUser : user
      // );
      // Update filtered users as well
      toast.success("assignment Updates successfully!");
  ...
  const handleAddNote = () => {
    axios
      .post(`${LIVE_URL}/assignment/assignment`, noteData)
      .then((response) => {
